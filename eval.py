...
for train_loader in train_loaders:
    train_loader.dataset.transform = test_loaders[0].dataset.transform
appr = Appr(args)
appr.eval(model, train_loaders, test_loaders, replay_loader, accelerator,test_loaders[0].dataset.transform)